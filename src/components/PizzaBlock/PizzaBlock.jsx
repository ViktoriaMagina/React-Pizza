...
export default function PizzaBlock({id, title, price, imageUrl, sizes, types}) {
    ...
    return(
        <div className="pizza-block">
          <div className="pizza-block__box-top">
              <img
          ...
          <div className="pizza-block__box-bottom">
          <div className="pizza-block__selector">
          <ul>
            {types.map((type, index) => {
                return(
                    <li key={index} onClick={()=> setActiveType(index)}  className={activeType === index ? "active": ""}>{typesNames[type]}</li>
                )
            })}
          </ul>
          <ul>
