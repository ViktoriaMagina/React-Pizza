...
const CartItem = ({id, title, price, imageUrl, size, type, count}) => {
    ...
    return(
        ...
        <div className="cart__item-count">
          ...
          <b>{count}</b>
          <div onClick={()=>dispatch(incrementItem({id, type, size}))} className="button button--outline button--circle cart__item-count-plus">
            <svg
              width="10"
              height="10"
              viewBox="0 0 10 10"
        ...
        <div onClick={()=> dispatch(removeProduct(id))} className="cart__item-remove">
